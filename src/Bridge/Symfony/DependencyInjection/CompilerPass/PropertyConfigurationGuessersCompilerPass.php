...
final class PropertyConfigurationGuessersCompilerPass extends AbstractCompilerPass
{
    public const TAG = 'fixture_test.property_guesser';
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        foreach ($services as $service) {
            $definition->addMethodCall('addPropertyConfigurationGuesser', [$service]);
        }
    }
